    ...
    <Layout title={"Register - Ecommer App"}>
      <div className={`sm:w-[50%] w-[90%] mx-auto text-center flex flex-col`}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="xl:p-6 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-full"
          >
            Register
          </button>
        </form>
